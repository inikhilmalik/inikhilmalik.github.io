    ...
    return (<>
        <Box id="about"  pt={{base:"55px",sm:"55px",md:"70px"}} className="about section" width={"90%"} margin={"auto"} pb={{ base: "70px", sm: "70px", md: "180px", lg: "1800px", '2xl': "180px" }}>
            ...
            <Box mt={{ base: "10px", md: "25px" }} width={{ base: "75%", md: "55%" }} margin={"auto"}>
                <Text id="user-detail-intro">Hii Everyone, My name is Nikhil Malik and i'm from New Delhi. I have completed my Bachlor of Technology specialzation in Mechanical Engineering from Delhi Technological University. I have also completed a full time course of Full Stack Web Devepolment from Masai School, Bangalore. Developing many websites using HTML, CSS, JavaScript, React, Node and can learn new software & technologies quickly. Capability to work in teams by providing valuable support. Seeking to advance a growing tech career as a Web Development Engineer.</Text>
            </Box>
